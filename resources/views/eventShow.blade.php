            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-col p-4">
                    ...
                    <div class="flex space-x-4 mt-6 bg-slate-200 p-2 rounded-md">
                        ...
                        <div class="flex flex-col">
                            <span class="text-2xl">{{ $event->user ? $event->user->name : 'Unknown User'}}</span>
                            <span class="text-2xl">{{ $event->user ? $event->user->email : 'Unknown User'}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end">
                <div class="flex flex-col">
                    <div class="mb-4 flex items-center text-sm font-medium">
                        ...
                        <div class="text-yellow-700">{{ $event->province->name }}</div>
                    </div>
